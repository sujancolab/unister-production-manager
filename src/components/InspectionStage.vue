        ...
        <ion-card-content>
            ...
            <div v-if="stage.completed" class="stage-details">
                <div class="detail-row">
                    ...
                    <span>Completed on: {{ formatDate(stage.final_inspection_completed_at) }}</span>
                </div>
                <div v-if="stage.completed_by" class="detail-row">
                    <ion-icon :icon="person" color="medium"></ion-icon>
                    <span>By: {{ stage.inspection_completed_by?.name }}</span>
                </div>
            ...
            <div v-if="stage.rejected" class="stage-details rejected-details">
                <div class="detail-row">
                    ...
                    <span>Rejected on: {{ formatDate(stage.final_inspection_rejected_at) }}</span>
                </div>
                <div v-if="stage.rejected_by" class="detail-row">
                    <ion-icon :icon="person" color="medium"></ion-icon>
                    <span>By: {{ stage.inspection_rejected_by?.name }}</span>
                </div>
