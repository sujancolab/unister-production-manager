                            ...
                            <ion-grid>
                                <ion-row>
                                    ...
                                    <ion-col size="12" size-md="6">
                                        ...
                                        <div v-if="selectionLoading.markNos || selectionLoading.inspectionData" class="select-loader">
                                            <ion-spinner name="crescent" />
                                            <span>{{ selectionLoading.markNos ? 'Loading mark numbers...' : 'Loading inspection data...' }}</span>
                                        </div>
                                    </ion-col>
                                </ion-row>
                            </ion-grid>

                            <ion-button expand="block" @click="loadFinalInspectionData" :disabled="!allSelectionsComplete || selectionLoading.inspectionData"
                                class="mark-button">
                                {{ selectionLoading.inspectionData ? 'Loading Inspection Data...' : 'Load Inspection Data' }}
                            </ion-button>
                        </ion-card-content>
                    </ion-card>
...
const loadFinalInspectionData = async () => {
    ...
    selectionLoading.inspectionData = true;
    try {
        ...
        selectionLoading.inspectionData = false;
    }
};
